...
export function OverviewView({
  ...
  const globalStats = {
    ...
    totalJobs: tenants.reduce(
      (sum, t) => sum + (t.completed_jobs || 0) + (t.active_jobs || 0),
      0
    ),
    totalMechanics: tenants.reduce(
      (sum, t) => sum + (t.mechanic_count || 0),
      0
    ),
  };
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                All registered garages on the platform
              </CardDescription>
            </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Latest payment activity across all garages
            </CardDescription>
          </CardHeader>
          <CardContent>
            {analyticsLoading ? (
            ...
            ) : globalAnalytics?.recentPayments &&
