        ...
        >
          <g clipPath="url(#clip0_186_1134)">
            ...
            <g mask="url(#mask0_186_1134)">
              ...
              <rect x="699.711" y="81" width="36" height="36" fill="#ffffff" fillOpacity="0.08" />
              <rect x="195.711" y="153" width="36" height="36" fill="#ffffff" fillOpacity="0.09" />
              <rect x="1023.71" y="153" width="36" height="36" fill="#ffffff" fillOpacity="0.09" />
              <rect x="123.711" y="225" width="36" height="36" fill="#ffffff" fillOpacity="0.09" />
              <rect x="1095.71" y="225" width="36" height="36" fill="#ffffff" fillOpacity="0.09" />
              <rect x="951.711" y="297" width="36" height="36" fill="#ffffff" fillOpacity="0.09" />
              <rect x="231.711" y="333" width="36" height="36" fill="#ffffff" fillOpacity="0.07" />
              <rect x="303.711" y="405" width="36" height="36" fill="#ffffff" fillOpacity="0.07" />
              <rect x="87.7109" y="405" width="36" height="36" fill="#ffffff" fillOpacity="0.09" />
              <rect x="519.711" y="405" width="36" height="36" fill="#ffffff" fillOpacity="0.08" />
              <rect x="771.711" y="405" width="36" height="36" fill="#ffffff" fillOpacity="0.09" />
              <rect x="591.711" y="477" width="36" height="36" fill="#ffffff" fillOpacity="0.07" />
            </g>
          ...
          <defs>
            ...
            >
              ...
              <stop offset="0.578125" stopColor="#4ade80" />
            ...
            >
              <stop stopColor="#ffffff" />
              <stop offset="0.157789" stopColor="#4ade80" />
              <stop offset="1" stopColor="#22c55e" />
            </radialGradient>
      ...
      <div className="relative z-10 mt-10 md:mt-14 lg:mt-16 w-full max-w-[1160px] px-4">
        <div className="bg-gradient-to-b from-emerald-500/30 to-transparent rounded-2xl p-1 md:p-2 shadow-2xl">
          <Image
            ...
            alt="Mechanix Dashboard Preview"
            width={1160}
            height={700}
