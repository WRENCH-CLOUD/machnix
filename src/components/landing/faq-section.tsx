...
const faqData = [
  {
    question: "What is Mechanix and who is it for?",
    answer:
      "Mechanix is a professional garage management platform designed for auto repair shops of all sizes. Whether you're a single-bay operation or managing multiple locations, Mechanix helps you streamline job tracking, customer communication, and shop operations.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "The free plan includes up to 50 jobs per month, 1 technician, basic job tracking, customer notifications, and invoicing with Mechanix branding. It's perfect for small shops or those wanting to try the platform before upgrading.",
  },
  {
      ...
      <div className="self-stretch pt-8 pb-8 md:pt-14 md:pb-14 flex flex-col justify-center items-center gap-2 relative z-10">
        <div className="flex flex-col justify-start items-center gap-4">
          ...
          <p className="self-stretch text-center text-muted-foreground text-sm font-medium leading-[18.20px] break-words">
            Everything you need to know about Mechanix and how it can transform your shop
          </p>
        </div>
      </div>
