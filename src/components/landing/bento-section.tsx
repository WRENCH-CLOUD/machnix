...
const BentoCard = ({ title, description, icon }: BentoCardProps) => (
  <div className="overflow-hidden rounded-2xl border border-white/20 flex flex-col justify-start items-start relative bg-white/[0.03]">
    {/* Optimized: removed expensive backdrop-filter blur, using simple bg opacity */}
    <div className="absolute inset-0 rounded-2xl bg-[rgba(231,236,235,0.06)]" />
  ...
  return (
    <section id="features-section" className="w-full px-5 flex flex-col justify-center items-center overflow-visible bg-transparent">
      <div className="w-full py-8 md:py-16 relative flex flex-col justify-start items-start gap-6">
        {/* Optimized: replaced blur-[130px] with radial gradient for better performance */}
        <div 
          className="w-[600px] h-[600px] absolute top-[400px] left-[0px] z-0 opacity-20 pointer-events-none"
          style={{
