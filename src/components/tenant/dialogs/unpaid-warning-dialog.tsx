  ...
  return (
    <TooltipProvider>
      <Dialog open={isOpen} onOpenChange={(open) => {
        ...
        <DialogContent 
          className="w-full max-w-md p-0 gap-0 border-0 bg-transparent shadow-none" 
                    ...
                    <div className="relative w-[100px] h-[100px] flex items-center justify-center">
                      ...
                      <AnimatePresence mode="wait">
                        {isCompleted ? (
                          ...
                          >
                            <div className="relative z-10 bg-card rounded-full p-5 border border-emerald-500">
                              <Check
                          ...
                          >
                            <div className="relative z-10">
                              ...
                              />
                              <div className="relative z-10 bg-card rounded-full p-5 shadow-[0_0_15px_rgba(16,185,129,0.1)]">
                          ...
                          <motion.div
                            ...
                            className="w-[100px] h-[100px] flex items-center justify-center"
                          >
                            <div className="relative z-10 bg-card rounded-full p-5 border-2 border-amber-500/30 shadow-[0_0_15px_rgba(245,158,11,0.1)]">
                ...
                >
                  <AnimatePresence mode="wait">
                    {isCompleted ? (
                      <motion.h2
                        key="completed-title"
                        className="text-lg text-foreground tracking-tight font-semibold"
