...
import { CustomersView } from "@/app/(tenant)/components/customers-view"
...
export default function CustomersPage() {
  ...
  return (
    <div className="flex h-screen bg-background">
      <AppSidebar activeView="customers" onViewChange={(view) => router.push(`/${view}`)} />
      <div className="flex-1 flex flex-col overflow-hidden">
        <TopHeader tenantName="Mechanix Garage" onCreateJob={() => router.push("/jobs/create")} />
