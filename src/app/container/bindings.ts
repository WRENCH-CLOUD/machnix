...
container.registerSingleton<AuthRepository>(
  REPOSITORY_TOKENS.auth,
  SupabaseAuthRepository
);
container.registerSingleton<TenantUserRepository>(
  REPOSITORY_TOKENS.tenantUser,
  SupabaseTenantUserRepository
);
container.registerSingleton<TenantRepository>(
  REPOSITORY_TOKENS.tenant,
  SupabaseTenantRepository
);
container.registerSingleton<CustomerRepository>(
  REPOSITORY_TOKENS.customer,
  SupabaseCustomerRepository
);
container.registerSingleton<EstimateRepository>(
  REPOSITORY_TOKENS.estimate,
  SupabaseEstimateRepository
);
container.registerSingleton<InvoiceRepository>(
  REPOSITORY_TOKENS.invoice,
  SupabaseInvoiceRepository
);
container.registerSingleton<JobRepository>(
  REPOSITORY_TOKENS.job,
