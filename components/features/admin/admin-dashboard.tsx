...
import { getAllTenants, type TenantWithStats, AnalyticsService, type GlobalAnalytics } from "@/lib/supabase/services"
            ...
            <>
              ...
              <div className="grid grid-cols-4 gap-4">
                {[
                  ...
                  {
                    title: "Total Revenue",
                    value: globalAnalytics ? `₹${(globalAnalytics.totalRevenue / 100000).toFixed(1)}L` : `₹${(globalStats.totalRevenue / 100000).toFixed(1)}L`,
                    icon: DollarSign,
                      ...
                      <div className="space-y-3">
                        {Object.entries(globalAnalytics.revenueByPaymentMethod)
                          ...
                          .map(([method, amount], index) => {
                            const total = Object.values(globalAnalytics.revenueByPaymentMethod).reduce((sum, val) => sum + val, 0)
